package com.calibroz.driver.listener;
...
public final class CalibrozWebDriverEventListener extends AbstractWebDriverEventListener {
	public final static Logger logger = Logger.getLogger(CalibrozWebDriverEventListener.class);
	@Override
